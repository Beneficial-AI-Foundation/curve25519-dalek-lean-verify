...
theorem reduce_spec (limbs : Array U64 5#usize) :
  ...
  · constructor
    ...
    · constructor
      ...
      · simp only [Field51_as_Nat, Array.getElem!_Nat_eq, Array.set_val_eq,
          UScalar.ofNatCore_val_eq, List.getElem!_eq_getElem?_getD, Finset.sum_range_succ,
          Finset.range_one, Finset.sum_singleton, mul_zero, pow_zero, List.length_set,
          List.Vector.length_val, Nat.ofNat_pos, getElem?_pos, ne_eq, OfNat.ofNat_ne_zero,
          not_false_eq_true, List.getElem_set_ne, one_ne_zero, List.getElem_set_self,
          Option.getD_some, getElem!_pos, UScalar.val_and, Nat.and_two_pow_sub_one_eq_mod,
          Nat.lt_add_one, one_mul, mul_one, Nat.one_lt_ofNat, OfNat.ofNat_ne_one, zero_ne_one,
          Nat.reduceMul, Nat.reduceLT, Nat.reduceEqDiff, Nat.succ_ne_self, OfNat.one_ne_ofNat,
          OfNat.zero_ne_ofNat, p, limbs10_post, limbs9_post, limbs8_post, limbs7_post, limbs6_post,
          limbs5_post, limbs4_post, limbs3_post, limbs2_post, limbs1_post, i17_post, i16_post,
          i6_post1, i_post, i5_post, i15_post, c4_post1, i4_post, i19_post, i18_post, i8_post1,
          i7_post, c0_post1, i21_post, i20_post, i10_post1, i9_post, c1_post1, i1_post, i23_post,
          i22_post, i12_post1, i11_post, c2_post1, i2_post, i25_post, i24_post, i14_post1, i13_post,
          c3_post1, i3_post]
        scalar_tac
