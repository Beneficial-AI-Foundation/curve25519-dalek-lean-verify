...
natural language description:
    ...
    • EIGHT_TORSION is a constant array of eight Edwards points representing the
      eight-torsion subgroup E[8] of the Edwards curve, i.e., the set of all
      points P where [8]P = 0.
...
natural language specs:
    ...
    • P has order eight (equivalent to [4]P ≠ 0 and [8]P = 0, because [8]P = 0
      implies that the order of P divides 8)
    • For all i ∈ {0,...,7}: EIGHT_TORSION[i] is a valid EdwardsPoint and
      EIGHT_TORSION[i] = [i]P
-/
