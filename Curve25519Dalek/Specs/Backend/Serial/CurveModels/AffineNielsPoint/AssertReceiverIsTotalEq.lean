...
/-!
# Spec theorem for `backend::serial::curve_models::AffineNielsPoint::assert_receiver_is_total_eq`
...
/-- **Spec theorem for
`backend::serial::curve_models::AffineNielsPoint::assert_receiver_is_total_eq`**
