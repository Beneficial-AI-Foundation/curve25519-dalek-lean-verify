...
/-- Trait implementation: [core::iter::adapters::map::{core::iter::traits::iterator::Iterator<B> for core::iter::adapters::map::Map<I, F>}]
...
/-- Trait implementation: [core::iter::sources::empty::{core::iter::traits::iterator::Iterator<T> for core::iter::sources::empty::Empty<T>}]
...
def core.iter.sources.empty.Empty.Insts.CoreIterTraitsIteratorIterator (T :
  Type) : core.iter.traits.iterator.Iterator (core.iter.sources.empty.Empty T)
  T := {
  next :=
  ...
  map := fun {B : Type} {F : Type} (opsfunctionFnMutPTupleBPInst :
    ...
    core.iter.sources.empty.Empty.Insts.CoreIterTraitsIteratorIterator.map
    opsfunctionFnMutPTupleBPInst
}
...
/-- [curve25519_dalek::backend::{core::clone::Clone for curve25519_dalek::backend::BackendKind}::clone]:
    Source: 'curve25519-dalek/src/backend/mod.rs', lines 45:15-45:20
    Visibility: public -/
...
/-- [curve25519_dalek::constants::BASEPOINT_ORDER]
    Source: 'curve25519-dalek/src/constants.rs', lines 73:0-73:60
    Visibility: public -/
@[global_simps, irreducible]
...
/-- Trait implementation: [curve25519_dalek::edwards::{core::iter::traits::accum::Sum<T> for curve25519_dalek::edwards::EdwardsPoint}]
    Source: 'curve25519-dalek/src/edwards.rs', lines 796:0-806:1 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::edwards::{curve25519_dalek::traits::MultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::edwards::EdwardsPoint}]
    Source: 'curve25519-dalek/src/edwards.rs', lines 926:0-955:1 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::edwards::{curve25519_dalek::traits::VartimeMultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::edwards::EdwardsPoint}]
    Source: 'curve25519-dalek/src/edwards.rs', lines 958:0-990:1 -/
@[reducible]
def
  ...
  vartime_multiscalar_mul := fun {I : Type} {J : Type} {Clause0_Item : Type}
    ...
    edwards.EdwardsPoint) =>
    edwards.EdwardsPoint.Insts.Curve25519_dalekTraitsVartimeMultiscalarMulEdwardsPoint.vartime_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
    coreitertraitscollectIntoIteratorInst1 coreborrowBorrowPEdwardsPointInst
    corecloneCloneEdwardsPointInst
}

/-- Trait implementation: [curve25519_dalek::edwards::{curve25519_dalek::traits::VartimePrecomputedMultiscalarMul<curve25519_dalek::edwards::EdwardsPoint> for curve25519_dalek::edwards::VartimeEdwardsPrecomputation}]
    Source: 'curve25519-dalek/src/edwards.rs', lines 1000:0-1035:1 -/
@[reducible]
def
  ...
  vartime_multiscalar_mul := fun {I : Type} {Clause0_Item : Type}
    ...
    (coreborrowBorrowPScalarInst : core.borrow.Borrow Clause0_Item
    scalar.Scalar) =>
    edwards.VartimeEdwardsPrecomputation.Insts.Curve25519_dalekTraitsVartimePrecomputedMultiscalarMulEdwardsPoint.vartime_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
  vartime_mixed_multiscalar_mul := fun {I : Type} {J : Type} {K : Type}
    ...
    edwards.EdwardsPoint) =>
    edwards.VartimeEdwardsPrecomputation.Insts.Curve25519_dalekTraitsVartimePrecomputedMultiscalarMulEdwardsPoint.vartime_mixed_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
...
/-- Trait implementation: [curve25519_dalek::ristretto::{core::iter::traits::accum::Sum<T> for curve25519_dalek::ristretto::RistrettoPoint}]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 931:0-941:1 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::ristretto::{curve25519_dalek::traits::MultiscalarMul<curve25519_dalek::ristretto::RistrettoPoint> for curve25519_dalek::ristretto::RistrettoPoint}]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 1014:0-1027:1 -/
@[reducible]
def
...
/-- Trait implementation: [curve25519_dalek::ristretto::{curve25519_dalek::traits::VartimeMultiscalarMul<curve25519_dalek::ristretto::RistrettoPoint> for curve25519_dalek::ristretto::RistrettoPoint}]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 1030:0-1043:1 -/
@[reducible]
def
  ...
  vartime_multiscalar_mul := fun {I : Type} {J : Type} {Clause0_Item : Type}
    ...
    ristretto.RistrettoPoint.Insts.Curve25519_dalekTraitsVartimeMultiscalarMulRistrettoPoint.vartime_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
    coreitertraitscollectIntoIteratorInst1 coreborrowBorrowPRistrettoPointInst
    corecloneCloneRistrettoPointInst
}

/-- Trait implementation: [curve25519_dalek::ristretto::{curve25519_dalek::traits::VartimePrecomputedMultiscalarMul<curve25519_dalek::ristretto::RistrettoPoint> for curve25519_dalek::ristretto::VartimeRistrettoPrecomputation}]
    Source: 'curve25519-dalek/src/ristretto.rs', lines 1056:0-1098:1 -/
@[reducible]
def
  ...
  vartime_multiscalar_mul := fun {I : Type} {Clause0_Item : Type}
    ...
    (coreborrowBorrowPScalarInst : core.borrow.Borrow Clause0_Item
    scalar.Scalar) =>
    ristretto.VartimeRistrettoPrecomputation.Insts.Curve25519_dalekTraitsVartimePrecomputedMultiscalarMulRistrettoPoint.vartime_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
  vartime_mixed_multiscalar_mul := fun {I : Type} {J : Type} {K : Type}
    {Clause0_Item : Type} {Clause0_IntoIter : Type} {Clause2_Item : Type}
    {Clause2_IntoIter : Type} {Clause4_Item : Type} {Clause4_IntoIter : Type}
    ...
    ristretto.RistrettoPoint) =>
    ristretto.VartimeRistrettoPrecomputation.Insts.Curve25519_dalekTraitsVartimePrecomputedMultiscalarMulRistrettoPoint.vartime_mixed_multiscalar_mul
    coreitertraitscollectIntoIteratorInst coreborrowBorrowPScalarInst
    coreitertraitscollectIntoIteratorInst1 coreborrowBorrowPScalarInst1
...
/-- Trait implementation: [curve25519_dalek::scalar::{core::iter::traits::accum::Product<T> for curve25519_dalek::scalar::Scalar}]
    Source: 'curve25519-dalek/src/scalar.rs', lines 460:0-470:1 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::scalar::{core::iter::traits::accum::Sum<T> for curve25519_dalek::scalar::Scalar}]
    Source: 'curve25519-dalek/src/scalar.rs', lines 472:0-482:1 -/
@[reducible]
...
def
  ...
  (c : traits.VartimeMultiscalarMul.vartime_multiscalar_mul.closure
  VartimeMultiscalarMulInst coreitertraitscollectIntoIteratorInst
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowInst corecloneCloneInst) (tupled_args : Clause3_Item) :
  Result ((Option Clause0_Point) ×
    (traits.VartimeMultiscalarMul.vartime_multiscalar_mul.closure
    VartimeMultiscalarMulInst coreitertraitscollectIntoIteratorInst
...
def
  ...
  VartimeMultiscalarMulInst coreitertraitscollectIntoIteratorInst
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowInst corecloneCloneInst) (t : Clause3_Item) :
  Result (Option Clause0_Point)
  := do
  let (o, _) ←
    traits.VartimeMultiscalarMul.vartime_multiscalar_mul.closure.Insts.CoreOpsFunctionFnMutTupleClause3_ItemOption.call_mut
...
def
  ...
  VartimeMultiscalarMulInst coreitertraitscollectIntoIteratorInst
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowInst corecloneCloneInst) Clause3_Item (Option Clause0_Point)
  := {
  call_once :=
    traits.VartimeMultiscalarMul.vartime_multiscalar_mul.closure.Insts.CoreOpsFunctionFnOnceTupleClause3_ItemOption.call_once
    VartimeMultiscalarMulInst coreitertraitscollectIntoIteratorInst
...
def
  ...
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowClause3_ItemScalarInst coreitertraitscollectIntoIteratorInst2
  coreborrowBorrowInst) (tupled_args : Clause5_Item) :
  Result ((Option Clause0_Point) ×
    (traits.VartimePrecomputedMultiscalarMul.vartime_mixed_multiscalar_mul.closure
    VartimePrecomputedMultiscalarMulInst coreitertraitscollectIntoIteratorInst
    coreborrowBorrowClause1_ItemScalarInst
...
def
  ...
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowClause3_ItemScalarInst coreitertraitscollectIntoIteratorInst2
  coreborrowBorrowInst) (t : Clause5_Item) :
  Result (Option Clause0_Point)
  := do
  let (o, _) ←
    traits.VartimePrecomputedMultiscalarMul.vartime_mixed_multiscalar_mul.closure.Insts.CoreOpsFunctionFnMutTupleClause5_ItemOption.call_mut
...
def
  ...
  coreborrowBorrowClause1_ItemScalarInst coreitertraitscollectIntoIteratorInst1
  coreborrowBorrowClause3_ItemScalarInst coreitertraitscollectIntoIteratorInst2
  coreborrowBorrowInst) Clause5_Item (Option Clause0_Point) := {
  call_once :=
    traits.VartimePrecomputedMultiscalarMul.vartime_mixed_multiscalar_mul.closure.Insts.CoreOpsFunctionFnOnceTupleClause5_ItemOption.call_once
    VartimePrecomputedMultiscalarMulInst coreitertraitscollectIntoIteratorInst
    coreborrowBorrowClause1_ItemScalarInst
...
/-- [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::LookupTable<T>}::clone]:
    Source: 'curve25519-dalek/src/window.rs', lines 47:23-47:28
    Visibility: public -/
...
/-- Trait implementation: [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::LookupTable<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 47:23-47:28 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::window::{core::marker::Copy for curve25519_dalek::window::LookupTable<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 47:17-47:21 -/
@[reducible]
...
/-- [curve25519_dalek::window::{core::default::Default for curve25519_dalek::window::LookupTable<T>}::default]:
    Source: 'curve25519-dalek/src/window.rs', lines 82:12-84:13
    Visibility: public -/
...
/-- Trait implementation: [curve25519_dalek::window::{core::default::Default for curve25519_dalek::window::LookupTable<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 81:8-85:9 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::LookupTable<curve25519_dalek::backend::serial::curve_models::ProjectiveNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 99:8-107:9 -/
@[reducible]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::LookupTable<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]: loop 0:
    Source: 'curve25519-dalek/src/window.rs', lines 113:16-139:26
    Visibility: public -/
@[rust_loop]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::LookupTable<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]:
    Source: 'curve25519-dalek/src/window.rs', lines 110:12-117:13
    Visibility: public -/
def
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::LookupTable<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 109:8-118:9 -/
@[reducible]
...
/-- [curve25519_dalek::window::{zeroize::Zeroize for curve25519_dalek::window::LookupTable<T>}::zeroize]:
    Source: 'curve25519-dalek/src/window.rs', lines 125:12-127:13
    Visibility: public -/
...
/-- Trait implementation: [curve25519_dalek::window::{zeroize::Zeroize for curve25519_dalek::window::LookupTable<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 121:8-128:9 -/
@[reducible]
...
/-- [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::NafLookupTable5<T>}::clone]:
    Source: 'curve25519-dalek/src/window.rs', lines 184:15-184:20
    Visibility: public -/
...
/-- Trait implementation: [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::NafLookupTable5<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 184:15-184:20 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::window::{core::marker::Copy for curve25519_dalek::window::NafLookupTable5<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 184:9-184:13 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable5<curve25519_dalek::backend::serial::curve_models::ProjectiveNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 203:0-213:1 -/
@[reducible]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable5<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]: loop 0:
    Source: 'curve25519-dalek/src/window.rs', lines 219:8-221:9
    Visibility: public -/
@[rust_loop]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable5<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]:
    Source: 'curve25519-dalek/src/window.rs', lines 216:4-224:5
    Visibility: public -/
def
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable5<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 215:0-225:1 -/
@[reducible]
def
...
/-- [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::NafLookupTable8<T>}::clone]:
    Source: 'curve25519-dalek/src/window.rs', lines 230:15-230:20
    Visibility: public -/
...
/-- Trait implementation: [curve25519_dalek::window::{core::clone::Clone for curve25519_dalek::window::NafLookupTable8<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 230:15-230:20 -/
@[reducible]
...
/-- Trait implementation: [curve25519_dalek::window::{core::marker::Copy for curve25519_dalek::window::NafLookupTable8<T>}]
    Source: 'curve25519-dalek/src/window.rs', lines 230:9-230:13 -/
@[reducible]
...
/-- [curve25519_dalek::window::{curve25519_dalek::window::NafLookupTable8<T>}::select]:
    Source: 'curve25519-dalek/src/window.rs', lines 235:4-240:5
    Visibility: public -/
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::ProjectiveNielsPoint>}::from]: loop 0:
    Source: 'curve25519-dalek/src/window.rs', lines 259:8-261:9
    Visibility: public -/
@[rust_loop]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::ProjectiveNielsPoint>}::from]:
    Source: 'curve25519-dalek/src/window.rs', lines 256:4-264:5
    Visibility: public -/
def
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::ProjectiveNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 255:0-265:1 -/
@[reducible]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]: loop 0:
    Source: 'curve25519-dalek/src/window.rs', lines 272:8-274:9
    Visibility: public -/
@[rust_loop]
def
...
/-- [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}::from]:
    Source: 'curve25519-dalek/src/window.rs', lines 269:4-277:5
    Visibility: public -/
def
...
/-- Trait implementation: [curve25519_dalek::window::{core::convert::From<&'a (curve25519_dalek::edwards::EdwardsPoint)> for curve25519_dalek::window::NafLookupTable8<curve25519_dalek::backend::serial::curve_models::AffineNielsPoint>}]
    Source: 'curve25519-dalek/src/window.rs', lines 268:0-278:1 -/
@[reducible]
def
